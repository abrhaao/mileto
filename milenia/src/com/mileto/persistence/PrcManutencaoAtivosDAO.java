...
import com.mileto.domain.MovMaintPlano;

public class PrcManutencaoAtivosDAO extends BaseDB {


	/**
	 * 
	 */
	public Collection<MovMaintPlano> getPlanosManutencao() throws DAOException {
		try {
			StringBuffer strBuffer = new StringBuffer();
			strBuffer.append(" FROM MovMaintPlano");
			...
			List<MovMaintPlano> objetos = query.list();
			return objetos;
		} catch (Exception e) {
			e.printStackTrace();
